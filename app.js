...
let hero = {
  isaac: {
    charImage: "resources/characters/hero/Isaac_lBlade_Front.gif",
    icon: "resources/characters/hero/hero-icons/Isaac.gif",
    name: "Isaac"
  },
  mia: {
    charImage: "resources/characters/hero/Mia_Mace_Front.gif",
...
let boots = { 
    levelOne: {
      ...
      leatherBoots: {
        name: "Leather Boots",
        description: "Why aren't there more of these around? Kill slimes a little quicker",
        level: 1,
        slimeKillAdd: 2,
        unique: true,
...
let monsters = {
  slimes: {
    weak: {
      name: "Weak Slime",
      image: "resources/monsters/slimes/Slime.gif",
      level: 1
    },
    meaty: {
      name: "Meaty Slime",
      image: "resources/monsters/slimes/Slime_Beast.gif",
      level: 2
    },
    chonky: {
      name: "Chonky Slime",
      image: "resources/monsters/slimes/Ooze.gif",
      level: 3
    }
  },
  brigand: {
    name "Brigand",
    image: "resources/monsters/Brigand.gif"
  },
  beasts: {
    goblin: {
      name: "Goblin",
      image: "resources/monsters/beasts/Alec_Goblin.gif",
      level: 1
    },
    antLion: {
      name: "Ant Lion",
      image: "resources/monsters/beasts/Ant_Lion.gif",
      level: 2
    },
    golem: {
      name: "Earth Golem",
      image: "resources/monsters/beasts/Golem.gif",
      level: 3
    },
    woodWalker: {
      name: "Wood Walker",
      image: "resources/monsters/beasts/Wood_Walker.gif",
      level: 4
    },
  },
  undead: {
    zombie: {
      name: "Zombie",
      image: "resources/monsters/undead/Zombie.gif",
      level: 1
    },
    skeleton: {
      name: "Skeleton",
      image: "resources/monsters/undead/Skeleton.gif",
      level: 2
    },
    ghoul: {
      name: "Ghoul",
      image: "resources/monsters/undead/Amaze.gif",
      level: 3
    },
    slayer: {
      name: "Slayer",
      image: "resources/monsters/undead/Slayer.gif",
      level: 4
    },
  }
}
  ...
  hirelings: {
    levelOne: {
      spectralArmor: {
        ...
        image: "resources/characters/hirelings/Azart.gif",
        slimeCost: 5
      },
      jenna: {
        name: "Jenna",
        quote: "Are you saying that I'm insensitive!?",
        level: 1,
        health: 50,
        unique: true,
      ...
      garet: {
        ...
        image: "resources/characters/hirelings/Garet_Mace_Front.gif",
        slimeCost: 10,
        slots: {}
      }
    },
    levelTwo: {
      sheba: {
        ...
        image: "resources/characters/hirelings/Sheba_Mace_Front.gif",
        slimeCost: 15,
        slots: {}
      },
      piers: {
        ...
        image: "resources/characters/hirelings/Piers_lSword_Front.gif",
        slimeCost: 15,
        slots: {}
      },
      ivan: {
        ...
        image: "resources/characters/hirelings/Ivan_Staff_Front.gif",
        slimeCost: 20,
        slots: {}
      }
    },
    levelThree: {
      mendardi: {
        name: "Menardi",
        quote: "Let's make haste!",
        level: 3,
        health: 100,
        unique: true,
        icon: "resources/characters/hirelings/hireicons/Menardi.gif",
        image: "resources/characters/hirelings/Menardi_Front.gif",
        slimeCost: 30,
        slots: {}
      },
      saturos: {
        ...
        image: "resources/characters/hirelings/Saturos_Front.gif",
        slimeCost: 30,
        slots: {}
      },
      felix: {
        ...
        image: "resources/characters/hirelings/Felix_lBlade_Front.gif",
        slimeCost: 40,
        slots: {}
      }
    },
    levelFour: {
      karst: {
        ...
        image: "resources/characters/hirelings/Karst_Front.gif",
        slimeCost: 50,
        slots: {}
      },
      agatio: {
        ...
        image: "resources/characters/hirelings/Agatio_Front.gif",
        slimeCost: 60,
        slots: {}
      }
    }
